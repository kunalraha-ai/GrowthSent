      ...
      >
        ...
        <nav className="sidebar-nav">
          ...
          <div className="nav-group">
            ...
            >
              ...
              <span className="nav-label">Link intelligence</span>
            </a>
            <a
        ...
        <ConfirmModal
          ...
          onConfirm={async () => {
            ...
            try {
              if (siteToDelete._id) {
                await fetch(`/api/v1/websites/${siteToDelete._id}`, {
                  method: "DELETE",
                })
              }

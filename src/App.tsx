...
const ClaudeIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
    <path d="M12 0C12.5523 0 13 0.447715 13 1V10.2929L19.5657 3.72718C19.9562 3.33666 20.5894 3.33666 20.9799 3.72718C21.3705 4.11771 21.3705 4.75087 20.9799 5.1414L14.4142 11.7071H23C23.5523 11.7071 24 12.1548 24 12.7071C24 13.2594 23.5523 13.7071 23 13.7071H14.4142L20.9799 20.2728C21.3705 20.6633 21.3705 21.2965 20.9799 21.687C20.5894 22.0775 19.9562 22.0775 19.5657 21.687L13 15.1213V24.4142C13 24.9665 12.5523 25.4142 12 25.4142C11.4477 25.4142 11 24.9665 11 24.4142V15.1213L4.43431 21.687C4.04379 22.0775 3.41063 22.0775 3.0201 21.687C2.62958 21.2965 2.62958 20.6633 3.0201 20.2728L9.58579 13.7071H1C0.447715 13.7071 0 13.2594 0 12.7071C0 12.1548 0.447715 11.7071 1 11.7071H9.58579L3.0201 5.1414C2.62958 4.75087 2.62958 4.11771 3.0201 3.72718C3.41063 3.33666 4.04379 3.33666 4.43431 3.72718L11 10.2929V1C11 0.447715 11.4477 0 12 0Z" fill="#D97757"/>
  </svg>
);
...
const CodexIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
    <path d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-6.5098-2.9A6.0651 6.0651 0 0 0 4.9807 4.1818a5.9847 5.9847 0 0 0-3.9977 2.9 6.0462 6.0462 0 0 0 .7427 7.0966 5.98 5.98 0 0 0 .511 4.9107 6.051 6.051 0 0 0 6.5146 2.9001A5.9847 5.9847 0 0 0 13.2599 24a6.0557 6.0557 0 0 0 5.7718-4.2058 5.9894 5.9894 0 0 0 3.9977-2.9001 6.0557 6.0557 0 0 0-.7475-7.0729zm-9.022 12.6081a4.4755 4.4755 0 0 1-2.8764-1.0408l.1419-.0814 4.7792-2.7582a.795.795 0 0 0 .3927-.6813v-6.7369l2.0204 1.1686a.071.071 0 0 1 .038.052v5.5826a4.504 4.504 0 0 1-4.4958 4.4958zm-9.6607-4.1254a4.4707 4.4707 0 0 1-.5355-3.0137l.142.0852 4.7839 2.7582a.795.795 0 0 0 .7901 0l5.8338-3.3693v2.3325a.0806.0806 0 0 1-.0332.0616l-4.836 2.7912a4.4944 4.4944 0 0 1-6.1451-1.6457zm-1.1278-10.4357A4.4755 4.4755 0 0 1 4.807 5.378l.0048.1635v5.5163a.7855.7855 0 0 0 .3927.6813l5.8338 3.3693-2.0204 1.1686a.0758.0758 0 0 1-.0711 0L4.1107 13.486a4.4992 4.4992 0 0 1-1.641-6.141zm16.488 4.097-5.8338-3.3693 2.0204-1.1686a.0758.0758 0 0 1 .0711 0l4.836 2.7912a4.4944 4.4944 0 0 1-.6586 8.1565v-5.7295a.7855.7855 0 0 0-.4351-.6803zm2.0802-3.3314a4.4707 4.4707 0 0 1 .5355 3.0137l-.142-.0852-4.7839-2.7582a.795.795 0 0 0-.7901 0l-5.8338 3.3693v-2.3325a.0806.0806 0 0 1 .0332-.0616l4.836-2.7912a4.4944 4.4944 0 0 1 6.1451 1.6457zM8.332 15.5342l-2.0204-1.1686a.071.071 0 0 1-.038-.052V8.731a4.504 4.504 0 0 1 7.3722-3.455l-.1419.0814-4.7792 2.7582a.795.795 0 0 0-.3927.6813v6.7369zm1.2084-2.8576 2.4593-1.4168 2.4593 1.4168v2.8336l-2.4593 1.4168-2.4593-1.4168z"/>
  </svg>
);
